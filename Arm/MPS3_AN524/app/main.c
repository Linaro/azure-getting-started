...
{
	return tx_mutex_create(&tfm_ns_dispatch_mutex, "TF-M Dispatch Mutex", TX_INHERIT);
}
...
void test_psa_level_1(void)
{
	...
	if (cfg_load_data(&cfg)) {
		printf("Error loading/generating app config data in SS.\n");
	}
